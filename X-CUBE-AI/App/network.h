...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "node_2_baseline_eqw"
...
#define AI_NETWORK_OUT_3_CHANNEL     (2)
#define AI_NETWORK_OUT_3_SIZE        (2)
#define AI_NETWORK_OUT_3_SIZE_BYTES  (8)
