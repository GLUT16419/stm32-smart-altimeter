...
#define AI_NETWORK_MODEL_SIGNATURE     "0x4b243cd3e12977e5168fda66b069cae6"
...
#define AI_TOOLS_DATE_TIME   "2026-07-09T17:32:42+0800"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 20, 32, 1, 1), AI_STRIDE_INIT(4, 4, 80, 2560, 2560),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 5072, 1, 1),
    5072, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &gemm_4_output, &gemm_5_output, &nl_3_output),
  &gemm_0_layer, 0x62701a18, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    gemm_0_output_array.data = AI_PTR(g_network_activations_map[0] + 80);
    gemm_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 80);
    nl_0_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 80);
    nl_0_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 80);
    ...
    nl_3_output_array.data = AI_PTR(g_network_activations_map[0] + 8);
    nl_3_output_array.data_start = AI_PTR(g_network_activations_map[0] + 8);
    ...
    gemm_5_output_array.data = AI_PTR(g_network_activations_map[0] + 4);
    gemm_5_output_array.data_start = AI_PTR(g_network_activations_map[0] + 4);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_1_weights_array.data = AI_PTR(g_network_weights_map[0] + 2688);
    gemm_1_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 2688);
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 4736);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 4736);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 4800);
    gemm_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 4800);
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 4928);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 4928);
    gemm_4_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_4_weights_array.data = AI_PTR(g_network_weights_map[0] + 4936);
    gemm_4_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 4936);
    gemm_4_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_4_bias_array.data = AI_PTR(g_network_weights_map[0] + 5000);
    gemm_4_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 5000);
    gemm_5_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_weights_array.data = AI_PTR(g_network_weights_map[0] + 5004);
    gemm_5_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 5004);
    gemm_5_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_bias_array.data = AI_PTR(g_network_weights_map[0] + 5068);
    gemm_5_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 5068);
    return true;
  }
